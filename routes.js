...
router.get("/armasRegistro",ensureAuthenticated,(req,res,next)=>{
    Arma.find()
    ...
    .exec((err,armas)=>{
        ...
        res.render("armasRegistro",{armas:armas});
    });
});
...
router.get("/armasRegistro",ensureAuthenticated,(req,res)=>{
    res.render("armasRegistro");
});
...
router.get("/interfaces",ensureAuthenticated,(req,res)=>{
    res.render("interfaces");
});

router.post("/interfaces",ensureAuthenticated,(req,res,next)=>{
    ...
    Arma.findOne({descripcion:descripcion},(err,arma)=>{
        ...
        newArma.save(next);
        return res.redirect("/armasRegistro");
    });
});
